...
<head>
  ...
  <link rel="stylesheet" href="css/profilEkskul.css">
...
<body>
  ...
  <div class="topbar">
    ...
    <h1 class="welcome-text">Good Morning, <span class="text-bold">neibluee</span></h1>
  ...
  <div class="dropdown" id="dropdownMenu">
    <div class="dropdown-header">
      ...
      <p><strong>neiblue</strong></p>
      <p style="color:gray">bebi@gmail.com</p>
    </div>
